...
public final class SMSMessage {
    ...
    public static String NOTIFY_DRIVER_WHEN_RIDERESERVE_IS_REMOVED = " cancels your ride\n";
    public static String NOTIFY_PASSENGER_WHEN_RIDERESERVE_IS_REMOVED = "You cancel a ride\n ";
